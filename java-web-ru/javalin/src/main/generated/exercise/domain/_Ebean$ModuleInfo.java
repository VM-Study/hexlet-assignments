...
@ModuleInfo(entities={"exercise.domain.Article","exercise.domain.Category"})
public class _Ebean$ModuleInfo implements ModuleInfoLoader {
  ...
  private List<Class<?>> defaultEntityClasses() {
    ...
    entities.add(exercise.domain.Article.class);
    entities.add(exercise.domain.Category.class);
    return entities;
  }
