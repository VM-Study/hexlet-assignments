...
class ValidationTest {
    ...
    // BEGIN
    @Test
    void testValidator_ShouldPrintLengthAndNullError_WhenInput() {
    ...
    @Test
    void testValidator_ShouldBeEmpty_WhenInput() {
        Address address = new Address("USA-225", "Texas", "123 Street", "7", "2");
        Map<String, List<String>> result = Validator.advancedValidate(address);
        assertThat(result).isEmpty();
    }

    @Test
    void testValidator_ShouldPrintCountyNull_WhenInput() {
        Address address = new Address(null, "Texas", "123 Street", "7", "2");
        Map<String, List<String>> expected = Map.of("country", List.of("can not be null"));
        Map<String, List<String>> result = Validator.advancedValidate(address);
        assertThat(result).isEqualTo(expected);
    }
