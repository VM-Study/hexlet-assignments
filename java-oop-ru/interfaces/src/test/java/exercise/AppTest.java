...
class AppTest {
    ...
    // BEGIN
    @Test
    void testReversedSequence_WhenCorrectInput() {
        String text = "abcdef";
    ...
    @Test
    void testReversedSequenceCharAt_WhenCorrectInput() {
        String text = "abcdef";
        int index = 1;
        String expected = "e";
        String result = String.valueOf(new ReversedSequence(text).charAt(index));
        assertThat(result).isEqualTo(expected);
    }

    @Test
    void testReversedSequenceSubSequence_WhenCorrectInput() {
        String text = "abcdef";
        int start = 1;
        int finish = 4;
        String expected = "edc";
        String result = String.valueOf(new ReversedSequence(text).subSequence(start, finish));
        assertThat(result).isEqualTo(expected);
    }
    // END
}
